...
export interface IMoveMaker {
    ...
    makeMoveAsync(board: IBoard, move: IMove): void;
...
export const MoveMaker: IMoveMaker = {
     ...
     isEnPassant(move: IMove): { fromX: number, targetX: number } | null {
        ...
        return  Piece.isEmpty(move.targetPiece) && xValid &&  yValid() && Piece.isPawn(move.piece) ? {fromX: fromX, targetX: targetX} : null;
    },
